...
#define Up_Tilt_Switch_Pin GPIO_PIN_10
#define Up_Tilt_Switch_GPIO_Port GPIOB
...
#define Down_Tilt_Switch_Pin GPIO_PIN_8
#define Down_Tilt_Switch_GPIO_Port GPIOA
